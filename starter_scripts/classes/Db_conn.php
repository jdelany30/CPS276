...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'jdelany';//this will be your WCC username
      $dbUsr = 'jdelany';//this will be your WCC username
      $dbPass = '7Y2bX4WrEeWa';//this will be the password found in the video.
